namespace Frontend.Models.Blocks.Shapes
{
    ...
    public static class ShapeTypeMethods
    {
        ...
        /// </summary>
        private static readonly Dictionary<ShapeType, Func<IBlockShape>> _dictionary = new() {
            ...
            { ShapeType.RECTANGLE, () => new DefaultShape("m 0,4 A 4,4 0 0,1 4,0 H 12 c 2,0 3,1 4,2 l 4,4 c 1,1 2,2 4,2 h 12 c 2,0 3,-1 4,-2 l 4,-4 c 1,-1 2,-2 4,-2 H %WIDTH% a 4,4 0 0,1 4,4 v 32 a 4,4 0 0,1 -4,4 H 48 c -2,0 -3,1 -4,2 l -4,4 c -1,1 -2,2 -4,2 h -12 c -2,0 -3,-1 -4,-2 l -4,-4 c -1,-1 -2,-2 -4,-2 H 4 a 4,4 0 0,1 -4,-4 z", ShapeType.RECTANGLE, new(0, 40), 130, 35) },
            //Height è solamente l'altezza dello spazio bianco
